...
export const TICKS_PER_FRAME = 16;
...
export const THROTTLE_DRAW_ADDRESS = FX0A_VX_ADDRESS + 0x01; // 0x1134
// Quirks
export const QUIRK_VF_RESET_ADDRESS = THROTTLE_DRAW_ADDRESS + 0x01; // 0x1135
export const QUIRK_MEMORY_ADDRESS = QUIRK_VF_RESET_ADDRESS + 0x01; // 0x1136
export const QUIRK_DISPLAY_WAIT_ADDRESS = QUIRK_MEMORY_ADDRESS + 0x01; // 0x1137
export const QUIRK_CLIPPING_ADDRESS = QUIRK_DISPLAY_WAIT_ADDRESS + 0x01; // 0x1138
export const QUIRK_SHIFTING_ADDRESS = QUIRK_CLIPPING_ADDRESS + 0x01; // 0x1139
export const QUIRK_JUMPING_ADDRESS = QUIRK_SHIFTING_ADDRESS + 0x01; // 0x113A
// Configurable ticks
export const TICKS_PER_FRAME_ADDRESS = QUIRK_JUMPING_ADDRESS + 0x01; // 0x113B
// Program counter (16-bit)
export const PC_ADDRESS = TICKS_PER_FRAME_ADDRESS + 0x01; // 0x113C
// I register (16-bit)
export const I_ADDRESS = PC_ADDRESS + 0x02; // 0x113D
// General-purpose registers V0–VF (16 bytes)
export const REGISTERS_ADDRESS = I_ADDRESS + 0x02; // 0x113F
