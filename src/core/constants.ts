...
export const PC_OFFSET = SOUND_TIMER_OFFSET + 0x01; // 0x1133
// I register (16-bit)
export const I_OFFSET = PC_OFFSET + 0x02; // 0x1135
// General-purpose registers V0–VF (16 bytes)
export const REGISTERS_OFFSET = I_OFFSET + 0x02; // 0x1137–0x1146
